...
class Check():
	...
	def addTanzoCheckCommandHandler(self,dispatcher):
		dispatcher.add_handler(CommandHandler("otp",self.cmd_otp))
		dispatcher.add_handler(CommandHandler("userlist",self.cmd_userlist))
		dispatcher.add_handler(CommandHandler("userdel",self.cmd_userdel))
